...
# for dev
#watchify -v -d -t [ reactify --es6 ] main.js -o front-src/build/js/compiled.js
#watchify -v -d -t [ reactify --es6 ] main.js -o front-src/build/js/compiled.js
#    "build": "gulp; NODE_ENV=development browserify -t [ reactify --es6 ] main.js > front-src/build/js/compiled.js; gulp server"
# for prod
